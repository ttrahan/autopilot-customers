...
var CONSUL_DNS = 'consul.svc.b71934f2-d224-cd47-fd4b-ef25fd4ee85f.us-east-1.triton.zone'; // 'consul';
...
var getUpstreams = function(force, callback) {
    if (upstreamHosts.length != 0 && !force) {
        ...
        http.get({
            host: 'consul.svc.b71934f2-d224-cd47-fd4b-ef25fd4ee85f.us-east-1.triton.zone', //'consul.svc.b71934f2-d224-cd47-fd4b-ef25fd4ee85f.us-east-1.triton.zone',
            port: 8500,
